...
namespace Gtk_Theme_Manager
{
    public class BashHandler
    {
        ...
        public bool UserThemeExtensionExists
        {
            get;
            set;
        }
        private BashHandler()
        {
            ...
            // CursorList.ForEach(s=>Console.WriteLine(s));
        ...
        {
            var str= Bash("gnome-extensions list --enabled | grep user-theme@gnome-shell-extensions.gcampax.github.com");
        ...
        {
            return Bash("gsettings get org.gnome.desktop.interface gtk-theme").Replace("\'", "").Trim();
        }
        
        public string GetIconTheme()
        {
            return Bash("gsettings get org.gnome.desktop.interface icon-theme").Replace("\'", "").Trim();
        }
        public string GetShellTheme()
        {
            return Bash("gsettings get org.gnome.shell.extensions.user-theme name").Replace("\'", "").Trim();
        }

        public String GetCursorTheme()
        {
            return Bash("gsettings get  org.gnome.desktop.interface cursor-theme").Replace("\'", "").Trim();
